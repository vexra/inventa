        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">
              {hasLowStock ? 'Ada barang di bawah batas minimum' : 'Stok di semua ruangan aman'}
            </p>
          </CardContent>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        ...
        <Card className="col-span-1">
          <CardHeader>
            ...
            <CardDescription>Daftar barang yang perlu diisi ulang per ruangan.</CardDescription>
          </CardHeader>
          <CardContent>
            {hasRooms ? (
              <div className="space-y-4">
                {!hasLowStock ? (
                  <div className="text-muted-foreground flex flex-col items-center justify-center py-8 text-center">
                    ...
                    <p className="text-sm">Semua stok aman terkendali.</p>
                  </div>
                ) : (
              ...
              <div className="text-muted-foreground py-8 text-center text-sm">
                Unit belum memiliki ruangan yang dikonfigurasi.
              </div>
            )}
          </CardContent>
          <CardFooter>
