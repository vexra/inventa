...
import { FileText, GraduationCap, MoreHorizontal, Pencil, Trash2 } from 'lucide-react'
...
export function FacultyList({ data }: FacultyListProps) {
      ...
      <AlertDialog open={!!deletingId} onOpenChange={(open) => !open && setDeletingId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Menghapus fakultas ini mungkin gagal jika masih terdapat Unit yang terhubung di
              dalamnya.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
